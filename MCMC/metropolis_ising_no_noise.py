...
def run_metropolis_without_noise(image):
    ...
    for beta in beta_range:
        ...
        images_processing.save_image(
            'metropolis_noise_ising_beta={0}_iter={1}_noise={2}'.format(beta, iterations, NOISE_LEVEL), 'jpg',
            sampled_image,
            'Denoised images/model_without_noise/brain_tissue_im/not_random')


if __name__ == '__main__':
    noised = cv2.imread('brain2_bw_noised.jpg')
    run_metropolis_without_noise(noised)
